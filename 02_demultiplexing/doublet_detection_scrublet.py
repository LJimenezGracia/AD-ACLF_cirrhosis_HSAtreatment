...
project = "CLARIAJOA"
subproject_path = "/mnt/cnagclus/projects/CLARIAJOA/01_cellranger_mapping"
metadata_path = "/mnt/cnagclus/projects/CLARIAJOA/01_cellranger_mapping/data/CLARIAJOA_metadata.csv"
scrublet_results_path = "/mnt/cnagclus/projects/CLARIAJOA/02_demultiplexing/results/doublet_prediction"
...
def main():
    ...
    for gem_id in libraries_list:
        ...
        counts_path = "{}/jobs/{}/{}/outs/filtered_feature_bc_matrix/matrix.mtx.gz".format(
            subproject_path, gem_id, gem_id)
        barcodes_path = "{}/jobs/{}/{}/outs/filtered_feature_bc_matrix/barcodes.tsv.gz".format(
            subproject_path, gem_id, gem_id)               
