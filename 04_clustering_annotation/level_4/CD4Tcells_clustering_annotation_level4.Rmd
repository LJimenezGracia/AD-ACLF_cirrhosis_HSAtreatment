...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/CLARIAJOA_clustering_level3_CD4Tcells.rds"))
...
openxlsx::write.xlsx(biomarkers_list, file = paste0(path_r_tables, "/CLARIAJOA_CD4Tcells_biomarkers_level4_res1.xlsx"))
```
...
memoryT_genes <- c("KLRB1", "KLRG1", "IL7R", "PRDM1", "PDCD1", "CCR7", "IL3RA", "EGR1", "ICOS", "PASK", "CD69", "FAS", "PD1", "CD27", "CD28", "ITGB1")
...
Treg_genes <- c("FOXP3", "CTLA4", "TIGIT", "DUSP4", "IL2RA", "LAG3", 
                "RORC", "IL17A", "IL17F", "CCR6", "CCR4", "CXCR3", "IFNG", "ICOS")
...
```{r fig.width=14, fig.height=10}
Tph_fh_genes <- c("CXCL13", "PDCD1", "CD200", "ICOS", "RORA", "RORC", "CXCR5", "CCR2", "BCL6", "GATA3",
                  "PRDM1", "IL17A", "IL17F", "IL10", "IL13", "IL21", "IL22", "IL26", "BATF", "IRF4", "TBX21", "IL12", "IL4", "IL6")
...
seurat_obj_integrated <- RenameIdents(
 seurat_obj_integrated,
  ...
  "1" = "Naive CD4+ T cells",
  "2" = "Naive CD4+ T cells",
  "3" = "Activated Memory CD4+ T cells",
  "4" = "Th17",
  "5" = "Th1",
  "6" = "Central Memory CD4+ T cells",
  "7" = "Effector Memory CD4+ T cells", 
  "8" = "Central Memory ITGB1+ CD4+ T cells",
  "9" = "CD25+Foxp3+ Treg", # DUSP+ CTLA4+ BATF+
  "10" = "CD25-Foxp3+ Treg", # DUSP- CTLA4-
  "11" = "Naive CD4+ T cells",
  "12" = "Cytotoxic CD8+ T cells",
  "13" = "Proliferative CD4+ T cells"
)
...
gg_umap_clustering_annot <- DimPlot(object = seurat_obj_integrated,
  ...
  labs(title = "CD4+ T cells - Level4")
gg_umap_clustering_annot

ggsave(filename = paste0(path_r_figs, "/CLARIAJOA_clustering_CD4Tcells_level4_annotation_umap.png"),
...
saveRDS(seurat_obj_integrated@meta.data[c("annot_level1", "annot_level2", "annot_level3", "annot_level4")],
        paste0(path_r_objects, "/CLARIAJOA_CD4Tcells_annotation_level4.rds"))

# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/CLARIAJOA_CD4Tcells_clustering_level4_annotation.rds"))
...
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/CLARIAJOA_CD4Tcells_level4_Juan.rds"))
```
