...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/CLARIAJOA_clustering_level3_NKcells.rds"))
...
openxlsx::write.xlsx(biomarkers_list, file = paste0(path_r_tables, "/CLARIAJOA_NKcells_biomarkers_level4_res0.4.xlsx"))
```
...
NKCD56bright_genes <- c("GPR183", "IL7R", "GZMK", "CD62L", "CD2", "KLRC1", "KLRD1", "NCAM1", "XCL1", "XCL2", "FCGR3A", "IL2RB", "IL2RA")
...
NKCD56dim_genes <- c("FCGR3A", "FCER1G", "GZMB", "GZMH", "CCL3", "CCL4", "CCL5", "NCR3", "CXCR4", 
                     "HIST1H1E", "ZEB2", "ANXA2", "CX3CR1", "ITGB2", "IL32", "CD7", "CFL1", "CST7", "PRF1", "LILRB1", "KIR", "KLRC2", "SH2D1B", "B3GAT1", "FCRL6", "TNFRSF9") 
...
```{r fig.width=15, fig.height=5}
IFN <- c("RLP10", "RPS2", "RPS15A", "MT-ND1") 
...
seurat_obj_integrated <- RenameIdents(
 seurat_obj_integrated,
  "0" = "CD56dim CD16+CD57+ NK cells",
  "1" = "CD56dim CD16+CD2+ NK cells",
  "2" = "CD56dim CD16+CD57- NK cells",
  "3" = "CD56dim CD16+CD57-CXCR4+ NK cells",
  "4" = "CD56bright NK cells",
 "5" = "NK cells cycling",
 "6" = "CD56dim CD16+IFNg+ NK cells"
)
...
gg_umap_clustering_annot <- DimPlot(object = seurat_obj_integrated,
  ...
  labs(title = "NK cells - level4")
gg_umap_clustering_annot

ggsave(filename = paste0(path_r_figs, "/CLARIAJOA_clustering_NKcells_level4_annotation_umap.png"),
...
saveRDS(seurat_obj_integrated@meta.data[c("annot_level1", "annot_level2", "annot_level3", "annot_level4")],
        paste0(path_r_objects, "/CLARIAJOA_NKcells_annotation_level4.rds"))

# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/CLARIAJOA_NKcells_clustering_level4_annotation.rds"))
#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/CLARIAJOA_NKcells_clustering_level4_annotation.rds"))
```
...
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/CLARIAJOA_NKcells_level4_Juan.rds"))
```
