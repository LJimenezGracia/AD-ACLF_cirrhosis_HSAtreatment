...
# Load Seurat object
seurat_obj_Tcells <- readRDS(paste0(path_r_objects, "/CLARIAJOA_clustering_level2_TNKcells_CD8Tcells.rds"))
seurat_obj_proliferativecells <- readRDS(paste0(path_r_objects, "/CLARIAJOA_clustering_level2_mixedcells_CD8Tcells.rds"))
...
Idents(seurat_obj_integrated) <- "RNA_snn_res.0.6"
...
openxlsx::write.xlsx(biomarkers_list, file = paste0(path_r_tables, "/CLARIAJOA_CD8Tcells_biomarkers_level3_res0.6.xlsx"))
```
...
seurat_obj_integrated <- RenameIdents(
 seurat_obj_integrated,
  ...
  "6" = "gd T cells",
  "7" = "Low quality cells", # HSP, stress
  "8" = "Low quality cells", # HSP, stress
  "9" = "Innate-like T cells", # TCR+ FCER1G+ innate-like T cells (?) https://www.nature.com/articles/s41392-022-01061-4
   "10" = "CD8+ T cells",
  "11" = "Proliferative CD8+ T cells",
 "12" = "CD8+ T cells"
)
...
gg_umap_clustering_annot <- DimPlot(object = seurat_obj_integrated,
  ...
  labs(title = "CD8+ T cells - Level3")
gg_umap_clustering_annot

ggsave(filename = paste0(path_r_figs, "/CLARIAJOA_clustering_CD8Tcells_level3_annotation_umap.png"),
...
saveRDS(seurat_obj_integrated@meta.data[c("annot_level1", "annot_level2", "annot_level3")],
        paste0(path_r_objects, "/CLARIAJOA_CD8Tcells_annotation_level3.rds"))

# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/CLARIAJOA_CD8Tcells_clustering_level3_annotation.rds"))
#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/CLARIAJOA_CD8Tcells_clustering_level3_annotation.rds"))
```
...
# CD8+ T cells
seurat_obj_CD8Tcells <- subset(seurat_obj_integrated, idents = c("Naive CD8+ T cells", "CD8+ T cells", "MAIT cells",
                                                                 "gd T cells", "Cytotoxic CD8+ T cells", "Innate-like T cells",
                                                                 "Proliferative CD8+ T cells"))
saveRDS(seurat_obj_CD8Tcells, paste0(path_r_objects, "/CLARIAJOA_clustering_level3_CD8Tcells.rds"))
