---
title: "Data normalization and pre-processing - NK cells"
...
# Load Seurat object
seurat_obj_NK <- readRDS(paste0(path_r_objects, "/CLARIAJOA_clustering_level2_TNKcells_NKcells.rds"))
seurat_obj_proliferativecells <- readRDS(paste0(path_r_objects, "/CLARIAJOA_clustering_level2_mixedcells_NKcells.rds"))

seurat_obj <- merge(seurat_obj_NK, seurat_obj_proliferativecells)
...
openxlsx::write.xlsx(biomarkers_list, file = paste0(path_r_tables, "/CLARIAJOA_NKcells_biomarkers_level3_res0.4.xlsx"))
```
...
NKT_genes <- c("CD3E", "CD3D", "IL7R", "NCAM1", "KLRB1", "FCGR3A", "XCL1", "XCL2", "IFNG")
...
```{r fig.width=25, fig.height=15}
matureNKCD56dim_genes <- c("NCAM1", "FCGR3A", "GZMB", "GZMH", "CCL3", "CCL4", "CCL5", "CD2",
                     "ITGB2", "PRF1", "B3GAT1", "FCRL6", "ACTB", "TSC22D3", "HCST", "S100A4") 
# High CD16 == FCGR3A, CD18 == ITGB2, PRF1, FCRL6, NCR3,CD57 == B3GAT1
FeaturePlot(seurat_obj_integrated,
            features = matureNKCD56dim_genes,
            #label = TRUE,
            #split.by = "tissue",
            pt.size = 0.25,
            ncol = 5
...
```{r fig.width=25, fig.height=15}
terminalNKCD56dim_genes <- c("NCAM1", "FCGR3A", "GZMB", "GZMH", "CCL3", "CCL4", "CCL5", "CD2",
                     "ITGB2", "PRF1", "B3GAT1", "FCRL6", "ACTB", "TSC22D3", "HCST", "S100A4",
                     "ZEB2", "CX3CR1", "HAVCR2", "HIST1H1E") 
# High CD16 == FCGR3A, CD18 == ITGB2, PRF1, FCRL6, NCR3,CD57 == B3GAT1
FeaturePlot(seurat_obj_integrated,
            features = terminalNKCD56dim_genes,
            #label = TRUE,
            #split.by = "tissue",
            pt.size = 0.25,
            ncol = 5
...
MAIT_genes <- c("KLRB1", "NKG7", "GZMK", "SLC4A10", "GZMA", "CXCR6", "NCR3",
                "TRAV1-2", "RORC", "RORA", "CCR6", "IL7R", "IL23R", "EOMES", "STAT4", "FOS")
...
doublets <- c("MS4A1", "CD3D",  "CD3E",  "HLA-DRA", "CD14") 
...
seurat_obj_integrated <- RenameIdents(
 seurat_obj_integrated,
  "0" = "CD56dim CD16+ NK cells",
  "1" = "NK-like CD8+ T cells",
  "2" = "CD56dim CD16+ NK cells",
  "3" = "CD56dim CD16+ NK cells",
  "4" = "CD56bright NK cells",
  "5" = "NK cells cycling",
  "6" = "Doublets"
)
...
ggsave(filename = paste0(path_r_figs, "/CLARIAJOA_clustering_NKcells_level3_annotation_umap.png"),
...
saveRDS(seurat_obj_integrated@meta.data[c("annot_level1", "annot_level2", "annot_level3")],
        paste0(path_r_objects, "/CLARIAJOA_NKcells_annotation_level3.rds"))

# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/CLARIAJOA_NKcells_clustering_level3_annotation.rds"))
#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/CLARIAJOA_NKcells_clustering_level3_annotation.rds"))
```
...
# CD8+ T cells
seurat_obj_CD8Tcells <- subset(seurat_obj_integrated, idents = c("NK-like CD8+ T cells"))
saveRDS(seurat_obj_CD8Tcells, paste0(path_r_objects, "/CLARIAJOA_clustering_level3_NKcells_CD8Tcells.rds"))
rm(seurat_obj_CD8Tcells)

# NK cells
seurat_obj_NKcells <- subset(seurat_obj_integrated, idents = c("CD56dim CD16+ NK cells", "CD56bright NK cells", "NK cells cycling"))
saveRDS(seurat_obj_NKcells, paste0(path_r_objects, "/CLARIAJOA_clustering_level3_NKcells.rds"))
