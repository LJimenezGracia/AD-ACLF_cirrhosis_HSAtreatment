...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/CLARIAJOA_clustering_level1_Blymphocytes.rds"))
...
openxlsx::write.xlsx(biomarkers_list, file = paste0(path_r_tables, "/CLARIAJOA_Blymphocytes_biomarkers_level2_res0.1.xlsx"))
```
...
Plasma_genes <- c("CD27", "JCHAIN", "XBP1", "CD38", "STMN1", "MKI67", "HLA-DRA", "MZB1", "SLAMF7", "SSR4")
...
```{r fig.width=20, fig.height=10}
Bmemory_genes <- c("CD27", "IGHD", "IGHM", "FAS", "CXCR3", "CXCR5", "FAS")
...
doublets <- c("MS4A1", "CD3D", "HLA-DRA", "CD14") 
...
seurat_obj_integrated <- RenameIdents(
 seurat_obj_integrated,
  ...
  "1" = "Memory B cells", 
  "2" = "Activated B cells", 
  "3" = "Doublets", # with Myeloid cells
  "4" = "Doublets", # with T cells
  "5" = "Complex Platelets-B cells"
)
...
ggsave(filename = paste0(path_r_figs, "/CLARIAJOA_clustering_Blymphocytes_level2_annotation_umap.png"),
...
saveRDS(seurat_obj_integrated@meta.data[c("annot_level1", "annot_level2")],
        paste0(path_r_objects, "/CLARIAJOA_Blymphocytes_annotation_level2.rds"))

# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/CLARIAJOA_Blymphocytes_clustering_level2_annotation.rds"))
#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/CLARIAJOA_Blymphocytes_clustering_level2_annotation.rds"))
```
...
```{r}
# B Lymphocytes
seurat_obj_blymphocytes <- subset(seurat_obj_integrated, idents = c("Naive B cells", "Activated B cells", "Memory B cells",
                                                                    "Complex Platelets-B cells"))
saveRDS(seurat_obj_blymphocytes, paste0(path_r_objects, "/CLARIAJOA_clustering_level2_Blymphocytes.rds"))
