---
title: "Data normalization and pre-processing - Mixed cells"
...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/CLARIAJOA_clustering_level1_mixedcells.rds"))
...
gg_pca_by_sample <- DimPlot(
  ...
  labs(title = "", color = "Donor disease_grade")
...
openxlsx::write.xlsx(biomarkers_list, file = paste0(path_r_tables, "/CLARIAJOA_mixedcells_biomarkers_level2_res0.25.xlsx"))
```
...
seurat_obj_integrated <- RenameIdents(
 seurat_obj_integrated,
  "0" = "Myeloid cells cycling",
  "1" = "Pre-plasmablasts",
  "2" = "Plasmablasts",
  "3" = "CD8+ T cells cycling",
  "4" = "CD4+ T cells cycling",
  "5" = "NK cells cycling",
  "6" = "Myeloid cells cycling",
  "7" = "Low quality cells"
)
...
gg_umap_clustering_annot <- DimPlot(object = seurat_obj_integrated,
  ...
  labs(title = "Mixed cells - Level2")
gg_umap_clustering_annot

ggsave(filename = paste0(path_r_figs, "/CLARIAJOA_clustering_mixedcells_level2_annotation_umap.png"),
...
saveRDS(seurat_obj_integrated@meta.data[c("annot_level1", "annot_level2")],
        paste0(path_r_objects, "/CLARIAJOA_mixedcells_annotation_level2.rds"))

# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/CLARIAJOA_mixedcells_clustering_level2_annotation.rds"))
#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/CLARIAJOA_mixedcells_clustering_level2_annotation.rds"))
```
...
```{r}
# CD4+ T cells
seurat_obj_CD4Tcells <- subset(seurat_obj_integrated, idents = "CD4+ T cells cycling")
saveRDS(seurat_obj_CD4Tcells, paste0(path_r_objects, "/CLARIAJOA_clustering_level2_mixedcells_CD4Tcells.rds"))
rm(seurat_obj_CD4Tcells)

# CD8+ T cells
seurat_obj_CD8Tcells <- subset(seurat_obj_integrated, idents = "CD8+ T cells cycling")
saveRDS(seurat_obj_CD8Tcells, paste0(path_r_objects, "/CLARIAJOA_clustering_level2_mixedcells_CD8Tcells.rds"))
rm(seurat_obj_CD8Tcells)

# NK cells
seurat_obj_NKcells <- subset(seurat_obj_integrated, idents = "NK cells cycling")
saveRDS(seurat_obj_NKcells, paste0(path_r_objects, "/CLARIAJOA_clustering_level2_mixedcells_NKcells.rds"))
rm(seurat_obj_NKcells)

# Myeloid cells
seurat_obj_myeloidcells <- subset(seurat_obj_integrated, idents = "Myeloid cells cycling")
saveRDS(seurat_obj_myeloidcells, paste0(path_r_objects, "/CLARIAJOA_clustering_level2_mixedcells_myeloidcells.rds"))
rm(seurat_obj_myeloidcells)

# B cells
seurat_obj_Bcells <- subset(seurat_obj_integrated, idents = c("Pre-plasmablasts", "Plasmablasts"))
saveRDS(seurat_obj_Bcells, paste0(path_r_objects, "/CLARIAJOA_clustering_level2_mixedcells_BLymphocytes.rds"))
rm(seurat_obj_Bcells)

# Low quality cells not saved!
```
