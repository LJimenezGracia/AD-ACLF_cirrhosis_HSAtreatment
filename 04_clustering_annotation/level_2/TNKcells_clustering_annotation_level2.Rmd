---
title: "Data normalization and pre-processing - T-NK cells"
...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/CLARIAJOA_clustering_level1_TNKcells.rds"))
...
openxlsx::write.xlsx(biomarkers_list, file = paste0(path_r_tables, "/CLARIAJOA_TNKcells_biomarkers_level2_res0.25.xlsx"))
```
...
NK_genes <- c("KLRC1", "KLRD1", "GZMK", "FCGR3A", "XCL1", "XCL2", "NCAM1", "PRDM1")
...
seurat_obj_integrated <- RenameIdents(
 seurat_obj_integrated,
  ...
  "1" = "CD4+ T cells",
  "2" = "CD8+ T cells",
  "3" = "NK cells", # both identities
  "4" = "CD8+ T cells",
  "5" = "CD4+ T cells",
  "6" = "CD8+ T cells",
  "7" = "Complex Platelets-T cells",
  "8" = "CD8+ T cells",
  "9" = "Low quality cells",
  "10" = "CD8+ T cells"
)
...
gg_umap_clustering_annot <- DimPlot(object = seurat_obj_integrated,
  ...
  labs(title = "T-NK cells - Level2")
gg_umap_clustering_annot

ggsave(filename = paste0(path_r_figs, "/CLARIAJOA_clustering_TNKcells_level2_annotation_umap.png"),
...
saveRDS(seurat_obj_integrated@meta.data[c("annot_level1", "annot_level2")],
        paste0(path_r_objects, "/CLARIAJOA_TNKcells_annotation_level2.rds"))

# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/CLARIAJOA_TNKcells_clustering_level2_annotation.rds"))
#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/CLARIAJOA_TNKcells_clustering_level2_annotation.rds"))
```
...
```{r}
# CD4+ T cells
seurat_obj_CD4Tcells <- subset(seurat_obj_integrated, idents = c("CD4+ T cells"))
saveRDS(seurat_obj_CD4Tcells, paste0(path_r_objects, "/CLARIAJOA_clustering_level2_TNKcells_CD4Tcells.rds"))
rm(seurat_obj_CD4Tcells)

# CD8+ T cells
seurat_obj_CD8Tcells <- subset(seurat_obj_integrated, idents = c("CD8+ T cells"))
saveRDS(seurat_obj_CD8Tcells, paste0(path_r_objects, "/CLARIAJOA_clustering_level2_TNKcells_CD8Tcells.rds"))
rm(seurat_obj_CD8Tcells)

# NK cells
seurat_obj_NKcells <- subset(seurat_obj_integrated, idents = c("NK cells"))
saveRDS(seurat_obj_NKcells, paste0(path_r_objects, "/CLARIAJOA_clustering_level2_TNKcells_NKcells.rds"))
