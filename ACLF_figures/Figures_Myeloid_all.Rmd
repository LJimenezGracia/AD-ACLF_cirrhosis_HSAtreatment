...
ggsave(paste0(path_r_figs_out, "/FigSupp1_MyeloidMarkers_dotplot.svg"),
       width = 12, height = 5,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/FigSupp1_MyeloidMarkers_dotplot_bycond.svg"),
       width = 16, height = 14,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/FigSupp_Myeloidcells_Abundance_disease-healthy.svg"),
       width = 18, height = 10,
       dpi = 300)
```
