...
ggsave(paste0(path_r_figs_out, "/FigSupp3_A_UMAPcells.svg"),
       width = 10, height = 6,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/FigSupp3_A_UMAPtreatment.svg"),
       width = 8, height = 6,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/FigSupp4_A_Abundance.svg"),
       width = 18, height = 8,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/FigSupp3_A_Markers_dotplot.svg"),
       width = 14, height = 7,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/FigSupp3_A_ext_Markers_dotplot_byconditions.svg"),
       width = 14, height = 12,
       dpi = 300)
```
