...
ggsave(paste0(path_r_figs_out, "/Fig3_E_UMAPcells.svg"),
       width = 10, height = 6,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/Fig3_F_UMAPtreatment.svg"),
       width = 8, height = 6,
       dpi = 300)
```
...
subset <- seurat_obj_metadata %>% 
  ...
  gather(key = "annot_level3", value = "n", `Classical Monocytes`:`GMP cells`)
...
ggsave(paste0(path_r_figs_out, "/Fig3_G_Abundance.svg"),
       width = 20, height = 12,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/FigSupp1_B_Markers_dotplot.svg"),
       width = 14, height = 7,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/FigSupp1_B_ext_Markers_dotplot_byconditions.svg"),
       width = 14, height = 12,
       dpi = 300)
```
...
ggsave(paste0(path_r_figs_out, "/FigSupp1_B_Markers_Heatmap.svg"),
       width = 20, height = 12,
       dpi = 100)
```
...
genes_to_plot <- c("CD14", "S100A8", "S100A12", "C1QA", "HLA-DPA1", "FCGR3A", "CYP1B1", "THBS1", "HLA-DRA")

FeaturePlot(seurat_obj, features = genes_to_plot, pt.size = 0.5, order = FALSE) &
  scale_colour_gradientn(colours = rev(brewer.pal(n = 10, name = "RdBu")))

ggsave(paste0(path_r_figs_out, "/FigSupp2_B_Genes.svg"),
       width = 15, height = 12,
       dpi = 300)
```
